...
default="nf_tables_default-"+locality+"_1.csv"
per_cpu="nf_tables_per_cpu-"+locality+"_2.csv"
#global_list="nf_tables_glob_lock-"+locality+"_0.csv"
per_cpu_san="nf_tables_per_cpu-"+locality+"_1_sanatized_traffic.csv"
global_list="nf_tables_per_cpu_single_queue-"+locality+"_0.csv"

df = pd.read_csv(default)
df1 = pd.read_csv(per_cpu)
df2 = pd.read_csv(global_list)
df3 = pd.read_csv(per_cpu_san)
#print(df1)
...
#plt.plot(df3['acl1_s'], df3['acl1'], label='per cpu sanatized')
#plt.plot(df3['acl2_s'], df3['acl2'], label='acl2 global list')
plt.plot(df3['acl3_s'], df3['acl3'], label='acl3 global list')
#plt.plot(df3['acl4_s'], df3['acl4'], label='acl4 global list')
#plt.plot(df3['acl5_s'], df3['acl5'], label='acl5 global list')
#plt.plot(df3['fw1_s'], df3['fw1'], label='fw1 global list')
#plt.plot(df3['fw2_s'], df3['fw2'], label='fw2 global list')
#plt.plot(df3['fw3_s'], df3['fw3'], label='fw3 global list')
#plt.plot(df3['fw4_s'], df3['fw4'], label='fw4 global list')
#plt.plot(df3['fw5_s'], df3['fw5'], label='fw5 global list')
#plt.plot(df3['ipc1_s'], df3['ipc1'], label='ipc1 global list')
#plt.plot(df3['ipc2_s'], df3['ipc2'], label='ipc2 global list')
